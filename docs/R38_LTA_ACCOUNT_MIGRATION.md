...
**`CROSSTRADE_ACCOUNTS` に設定されていた `APEX4568750000010` は、CrossTrade の
...
| 口座 | accountId | env | 判定 |
|---|---|---|---|
| `LFE02562316710003` | 61965347 | demo | 生存（旧 Lucid・不使用） |
| `LTATANOBA1001064330885` | 63077661 | demo | **LTA-A（発注先）** |
| `LTATANOBA1005923156221` | 63077660 | demo | **LTA-B（R40で発注先へ追加）** |
| `APEX4568750000010` | — | — | **一覧に無い** |
...
```
CROSSTRADE_ACCOUNTS=LTATANOBA1001064330885,LTATANOBA1005923156221
RISK_LTATANOBA1001064330885=240
LIFELINE_LTATANOBA1001064330885=3000
TARGET_LTATANOBA1001064330885=6000
DAYGOAL_LTATANOBA1001064330885=900
RISK_LTATANOBA1005923156221=240
LIFELINE_LTATANOBA1005923156221=3000
TARGET_LTATANOBA1005923156221=6000
DAYGOAL_LTATANOBA1005923156221=900
...
```
configured_accounts       : ['LTATANOBA1001064330885', 'LTATANOBA1005923156221']
